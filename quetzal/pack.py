# https://github.com/graphcore/examples/blob/2d8b565326ef6ba730492ad8badd984b067645bc/tutorials/blogs_code/packedBERT/lpfhp.py
...
def pack_using_lpfhp(histogram, max_sequence_length, max_sequences_per_pack, distribute=True, stats=False):
    """Longest-pack-first histogram-packing."""
    start = time.time()
